...
parser.add_argument('--model_path', type=str, default='model/lamDARTS_CR20lei_best_weights.pt', help='path of pretrained model')
...
def main():
    ...
    def TrainDatasetKshotRround(num, k):
        X, Y = load_data('/data/zhangxx/SEI/HYX_FS-SEI/data/IDX',
                         "train8dB-images-idx3-ubyte.gz", "train8dB-labels-idx1-ubyte.gz")
    ...
    data, label = load_data(
        ...
        "test8dB-images-idx3-ubyte.gz", "test8dB-labels-idx1-ubyte.gz")
    ...
    df = pd.DataFrame(acc)
    df.to_excel(f"result/lamDARTSs1_CR20lei_8dB.xlsx", index=False)
    ...
    df.to_excel(f"result/lamDARTSs1_CR20lei_8dB_3m.xlsx", index=False)
